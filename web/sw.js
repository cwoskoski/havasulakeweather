...
const CACHE = "havasu-wx-v42";  // bump on EVERY web/ change (cache correctness; CI-enforced)
const RELEASE = "r6";           // bump ONLY for user-facing changes — drives the "update available" toast
const SHELL = [
