...
const CACHE = "havasu-wx-v43";  // bump on EVERY web/ change (cache correctness; CI-enforced)
const RELEASE = "r7";           // bump ONLY for user-facing changes — drives the "update available" toast
const SHELL = [
